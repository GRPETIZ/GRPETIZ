...
🚀 Technical Support Professional and Back-end Developer 🚀

🔧 Experienced technical support professional with solid skills in:

Formatting machines and performing preventive maintenance on notebooks and desktops.
Building topologies and flowcharts of infrastructure to ensure operational efficiency.
Managing users in Microsoft 365 and Google Workspace, optimizing collaboration and productivity.
Basic knowledge of infrastructure hardware for diagnosis and troubleshooting.
Installing essential software to support company operations.
Basic management of Azure AD and Jumpcloud for access and security administration.
💻 Additional experience in Junior Back-end Development, using C#:

Automation of processes to increase operational efficiency.
Debugging code to ensure high quality and performance.
Integration with external APIs to enhance system functionality.
Running MySQL queries to support data analysis, driving informed decision-making.
🌍 Advanced English: Reading, writing, and communication to effectively collaborate in international environments.

💼 Determined to transition into the field of C# back-end development, seeking challenging and exciting opportunities where I can apply my experience and continuously learn.
</details>
